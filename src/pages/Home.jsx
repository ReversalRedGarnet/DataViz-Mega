...
const SECTION_TONES = ['plain', 'panel']
...
export default function Home() {
  ...
  return (
    <>
      ...
      <PacificBorder colorAbove={SECTION_COLORS[heroTone]} colorBelow={SECTION_COLORS[gridTone]} />
      ...
      <PacificBorder colorAbove={SECTION_COLORS[gridTone]} colorBelow={SECTION_COLORS[FOOTER_TONE]} />
